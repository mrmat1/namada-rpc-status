...
export const RpcStatusTable = ({ columns, data, isLoading, network , isPagging }) => {
            ...
            <span>
              ...
              <Tooltip title="Copied">
                <Copy
                  ...
                  onClick={(e) => copyToClipBoard(row.rpc)}
                />
              </Tooltip>
            </span>
          </TableCell>
          <TableCell align="left">
            <span>{row.latest_block_height}</span>
          </TableCell>
          <TableCell align="left">
            <span>{row.latency}s</span>
          </TableCell>
          <TableCell align="left">
            <span>
              {parseFloat(network.latestBlockHeight - row.latest_block_height) -
                5 <
              0 ? (
                ...
                <CancelSharpIcon fontSize="small" style={{ color: "red" }} />
              )}
            </span>
          </TableCell>
          <TableCell align="left">
